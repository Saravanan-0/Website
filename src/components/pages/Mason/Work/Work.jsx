...
const Work = () => {
  return (
    <div className='work344'>
      <div className='work-heading34'>
        <h1>What we do</h1>
      </div>
      <div className='work-card34'>
        <div className="work134" >
          <div className='work-head34'><img src= {img1} />
          <h2>Company Incorporation</h2>
          </div>
          <div className="work-content34">
        ...
        <div className="work134" >
          <div className='work-head34'><img src= {img4} />
          <h2>Team setup</h2>
          </div>
          <div className="work-content34">
        ...
        <div className="work134" >
          <div className='work-head34'><img src= {img5} />
        ...
        <div className="work134" >
          <div className='work-head345'><img src= {img12} />
          <h2>Transfer</h2>
          </div>
          <div className="work-content34">
